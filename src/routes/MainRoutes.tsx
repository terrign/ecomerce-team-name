  ...
  return (
    <Routes>
      ...
      <Route path={`${RouterPath.CATALOG}`} element={<Catalog />}>
        <Route path={`${RouterPath.CATALOG}/:category`} element={<Catalog />}>
          <Route path={`${RouterPath.CATALOG}/:category/:subCategory`} element={<Catalog />}></Route>
          <Route path={`${RouterPath.CATALOG}/:category/*`} element={<Page404 />}></Route>
        </Route>
